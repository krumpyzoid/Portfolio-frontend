...
<div class="portfolio__modal" :class="{'portfolio__modal--active': modalActive}">
  <svg @click="closeContactForm()" class="portfolio__modal-close" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
      width="50" height="50"
      viewBox="0 0 172 172"
...
<section id="portfolio" >
  <div class="container">
    ...
    <div class="portfolio">
      <PortfolioItem v-for="item in sortedPortolioItems" v-bind:key="item.id" :item="item"/>
    </div>
  </div>
</section>
<section id="footer">
...
export default {
  ...
  data() {
    return {
      ...
      heroButtonsShownText: false,
      fixedButtonActive: false,
      fixedButtonActiveIcon: false,
      items: {},
      modalActive: false,
      portfolioItems: [{"id":3,"overline":"web app & robotic process automation","heading":"La Boite à Messages","description":"Projet de mentorat d'un étudiant en licence d'informatique. La Boite à Message est un site internet permettant de publier des messages sur nos pages twitter et instagram de façon anonyme","order":3,"casestudy":"<h2>00. Point de départ</h2>\n<p>Ce projet m’a été présenté par un ami étudiant en école d’informatique. Il a eu l’idée et mis sur pied un site internet permettant de poster des messages anonymes sur sa page Twitter et Instagram.\nIntéressé par le projet, je lui ai proposé un coup de main pour restructurer le projet afin d’en améliorer la qualité et la scalabilité.\nLe projet est en développement et sera bientôt disponible sur github afin de donner la possibilité à n’importe qui de créer ce genre de page pour sa communauté.</p>\n\n<h2>01. Design du système</h2>\n<p>Le système de base reposait sur un serveur flask qui a rapidement montré ses limites à cause des restrictions sur Instagram. De plus, le créateur montrait un intérêt pour les technologies front qu’il ne connaissait pas encore.</p>\n\n<p>Nous avons donc choisi de réorganiser l’application en 3 couches.\n1 serveur front-end avec VueJS hosté sur Netlify\n1 serveur back-end avec NodeJS + Strapi & PostgreSQL hosté sur Heroku\nPlusieurs scripts tournant sur des machines Heroku, chargés de l’automatisation des post avec Selenium</p>\n\n<h2>02. Mon travail</h2>\n<h3>02.1 Le front</h3>\n<p>J’ai redesigné le front-end en une page sobre et élégante. Un bouton permet de choisir sur quel réseau l’utilisateur souhaite poster.\nLe formulaire est directement intégré à l’UI sur la feuille. Lors de l’envoi du formulaire, si le serveur valide l’enregistrement dans la base de donnée, la lettre se ferme et sort de l’écran pour simuler l’envoi, et une nouvelle lettre vierge apparaît.</p>\n\n<h3>02.2 Le dispatcher</h3>\n<p>Nous avons utilisé le CMS Headless Strapi pour réaliser le dispatcher. Celui-ci permet de créer aisément des modèles, administrer la base de données et crée par défaut une API efficace pour obtenir les messages avec nos scripts Selenium.<p>\n","website":"http://anon-letter.com","published_at":"2021-12-01T16:14:02.574Z","created_at":"2021-12-01T16:13:33.627Z","updated_at":"2021-12-02T12:33:45.680Z","imgurl":"https://i.imgur.com/8OO3zNh.jpg","carousel":[],"tags":[{"id":1,"tag":"HTML/CSS","published_at":"2021-12-01T14:43:57.664Z","created_at":"2021-12-01T14:43:56.056Z","updated_at":"2021-12-01T14:43:57.679Z"},{"id":3,"tag":"Vue.js","published_at":"2021-12-01T15:02:40.851Z","created_at":"2021-12-01T15:02:39.309Z","updated_at":"2021-12-01T15:02:40.860Z"},{"id":4,"tag":"Node.js","published_at":"2021-12-01T15:02:48.842Z","created_at":"2021-12-01T15:02:46.252Z","updated_at":"2021-12-01T15:02:48.851Z"}]},{"id":1,"overline":"Site statique Wordpress","heading":"Concours de Piano Claude Kahn","description":"Refonte du site internet du Concours de Piano Claude Kahn, concours international prestigieux créé en 1970","order":1,"casestudy":"<h2>00. Point de départ</h2>\n<p>Un site internet était déjà existant. Développé au début des années 2000, il a servi de biographie pour M. Claude Kahn ainsi que de vitrine du concours.\nLe site internet a été développé en pur HTML/CSS et était obligatoirement maintenu par le créateur sans possibilité pour l’administration d’éditer ou ajouter du contenu.\nLe site se composait de plusieurs pages statiques (Accueil, Biographie, Concours, Presse, Répertoire, Galerie Photo, Contact) qui entremêlaient la vie du concours avec M. Claude Kahn.\nLe contenu était peu mis à jour depuis des années en dehors de la liste des lauréats du concours ainsi que des vidéos de leurs auditions.</p>\n<h2>01. Brief</h2>\n<p>Le site a besoin d’une refonte complète. Tout d’abord, l’aspect esthétique doit être mis à jour pour s’aligner sur les normes du web moderne. La structure du site est à revoir, le sujet principal du site sera désormais le concours, mais il faudra tout de même présenter son créateur, Claude Kahn. Notre équipe doit être capable d’éditer et ajouter du contenu, et la technologie utilisée doit pouvoir évoluer dans le temps.</p>\n\n<h2>02. Choix stratégiques</h2>\n<h3>02.1 La structure</h3>\n<p>Le site internet a été repensé en deux pages, l’une dédiée au concours et servant de page d’accueil, l’autre dédiée à M. Kahn.\nLa page d’accueil présente plus en détail le concours, son jury, programme et ses lauréats. Des blocs dynamiques (accordéon, tabulations) permettent d’utiliser un minimum d’espace pour un maximum de données.\nLes apparitions dans la presse ayant quasiment disparu, elles ne figurent plus sur le site internet qui se veut tourné vers l’avenir.\nLa biographie de M. Kahn est découpée en plusieurs blocs précédés de chiffres clés facilitant et entraînant la lecture.</p>\n\n<h3>02.2 Les technologies</h3>\n<p>Afin de rendre le site facilement éditable par l’équipe associative nous nous sommes tournés vers WordPress. Cette technologie offre un panel d’administration, une grande communauté fournissant des plug-in pouvant être installés par la suite (ex: inscriptions en ligne) et des mises à jour de sécurité régulières.\nCouplé à WordPress, j’ai fait le choix d’utiliser Oxygen, un page builder proche d’un outil comme Webflow, permettant d’avoir un contrôle absolu sur le rendu visuel du site tout en offrant des performances impressionnantes.</p>\n","website":"https://www.claude-kahn.info/","published_at":"2021-12-01T15:03:53.049Z","created_at":"2021-12-01T15:03:50.857Z","updated_at":"2021-12-02T12:31:05.615Z","imgurl":"https://i.imgur.com/B0HufVW.jpg","carousel":[],"tags":[{"id":5,"tag":"Wordpress","published_at":"2021-12-01T15:02:58.560Z","created_at":"2021-12-01T15:02:56.934Z","updated_at":"2021-12-01T15:02:58.569Z"},{"id":6,"tag":"Oxygen","published_at":"2021-12-01T15:03:06.049Z","created_at":"2021-12-01T15:03:04.312Z","updated_at":"2021-12-01T15:03:06.058Z"}]},{"id":2,"overline":"Single page Web app","heading":"Double Détente","description":"Refonte du site internet de Double Détente, salon de massage de la commune de Saint-Germain-en-Laye (78)","order":2,"casestudy":"<h2>00. Point de départ</h2>\n<p>Un site internet était déjà existant, développé dans le début des années 2010. La charte graphique manquait clairement de nouveau. La navigation était difficile de part une mauvaise catégorisation des prestations, en plus d’une double structure (la boutique en ligne était séparée de la vitrine).</p>\n\n<h2>02. Choix stratégiques</h2>\n<h3>02.1 La structure<h3>\n<p>Le site a été repensé en suivant les tendances actuelles. Une seule page, d’accueil, et une page produit permettent d’accéder à toutes les informations, commande et paiement des prestations.</p>\n<h3>02.2 Le design<h3>\n<p>Tout en essayant de s’abstenir de tomber dans les clichés, la charte graphique a été revisitée en monochrome de rose/violet (Pantone 2365C), les photos ont été mises à jour à partir de banques d’images libre de droit en prenant soin de garder une ligne directrice dans la qualité, cadrage et ambiance des photos.\nLe design suit une tendance flat avec des aplats de couleurs sans dégradés ou ombres, jouant uniquement sur les contrastes et espacements.</p>\n<h3>02.3 Les technologies<h3>\n<p>Le site internet a été réalisé en utilisant VueJS pour le front-end et un paymentwall Paypal car les clients y étaient habitués.\nCôté serveur, un serveur NodeJS + Express et une base de données MongoDB.\nUn panel administrateur a été créé pour éditer/ajouter des prestations, mais aussi un agenda en ligne permettant d’organiser les rendez-vous du cabinet. Le client a souhaité continuer sur la méthode des bons cadeaux plutôt que la prise de rendez-vous directe.</p>\n","website":"https://www.double-detente.com/","published_at":"2021-12-01T16:12:59.279Z","created_at":"2021-12-01T16:12:57.353Z","updated_at":"2021-12-02T12:33:54.304Z","imgurl":"https://i.imgur.com/8OO3zNh.jpg","carousel":[],"tags":[{"id":1,"tag":"HTML/CSS","published_at":"2021-12-01T14:43:57.664Z","created_at":"2021-12-01T14:43:56.056Z","updated_at":"2021-12-01T14:43:57.679Z"},{"id":3,"tag":"Vue.js","published_at":"2021-12-01T15:02:40.851Z","created_at":"2021-12-01T15:02:39.309Z","updated_at":"2021-12-01T15:02:40.860Z"},{"id":4,"tag":"Node.js","published_at":"2021-12-01T15:02:48.842Z","created_at":"2021-12-01T15:02:46.252Z","updated_at":"2021-12-01T15:02:48.851Z"}]}]
    }
  },
  computed: {
    sortedPortolioItems() {
      let sortedArray = this.portfolioItems.sort((a,b) => (a.order > b.order) ? 1 : ((b.order > a.order) ? -1 : 0))
      return sortedArray
    }
  },
  methods: {
    ...
    get_scroll_position() {
        window.addEventListener('scroll', () => {
            ...
            if (this.scrollPosition < this.btnheight) { this.fixedButtonActive = false; this.fixedButtonActiveIcon = false}
        });
    ...
    contactAnimation() {
      ...
      if (!this.heroButtonsShown) {
        heroButtons.classList.add('hero__buttons--visible')
        this.heroButtonsShown = true
        this.heroButtonsShownText = true
        setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          this.heroButtonsShownText = false
        }, 1500)
      }
    },
    fixedContactAnimation() {
      let contactList = document.getElementsByClassName('contact__button')[0];
      let contactButton = document.getElementsByClassName('button-fixed__button')[0];
      if (!this.fixedButtonActive) {
        contactList.classList.add('button--fixed--active')
        contactButton.classList.remove('animate__pulse')
        this.fixedButtonActive = true;
        this.fixedButtonActiveIcon = true;
      } else {
        contactList.classList.remove('button--fixed--active')
        contactButton.classList.add('animate__pulse')
